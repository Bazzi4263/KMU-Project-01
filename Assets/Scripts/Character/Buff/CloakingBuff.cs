...
public class CloakingBuff : Basebuff
{
    protected override void init()
    {
        ...
        shadowbuff.thiefShadowObj.GetComponent<SpriteRenderer>().DOFade(0.2f, 0.5f);
    ...
    protected override void OnDestroy()
    {
        ...
        ShadowPartnerBuff shadowbuff = (ShadowPartnerBuff)affectedchara.bufflist.Find(x => x.GetType() == typeof(ShadowPartnerBuff));
        shadowbuff.thiefShadowObj.GetComponent<SpriteRenderer>().DOFade(1f, 0.1f);
        base.OnDestroy();
    }
